 ...
 */
package net.librebounce.utils.io
 ...
 */
val DEFAULT_AGENT =
    "${LibreBounce.CLIENT_NAME}/${LibreBounce.clientVersionText} (${LibreBounce.clientCommit}, ${LibreBounce.clientBranch}, ${if (LibreBounce.IN_DEV) "dev" else "release"}, ${System.getProperty("os.name")})"
